...
main:
    ...
    ; Guardar backup de SystemTable
    mov r15, rdx

    ; UEFI spec dice que requiere preparar espacio en la pila. Pero hemos probado sin esa reserva y funciona :-?
    ; Vamos a reservarlo igualmente:
