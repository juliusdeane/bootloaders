...
stage2_start:
    ...
    ; Saltamos a 0x1000000 + 0x1000
    ; - primera instrucción según objdump
    ; callw 0x...
    ; - PERO AHORA INDICANDO UN FAR (dword)
    jmp dword 0x1001000
...
msg_kernel_jmp:     db '[KERNEL] Pulsa una tecla para saltar a far 0x1001000', 13, 10, 0
