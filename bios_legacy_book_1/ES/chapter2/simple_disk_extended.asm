...
start:
    ...
    call debug_print_string16
    call print_string
    ; Si no ha habido error, vamos a imprimir las letras B.
    mov si, 0x8000
    call print_string
    ; ************************************************************************
...
DAP:
    ...
    ; Offset a una posición de memoria segura.
    ; - copiemos la misma que hemos usado con CHS
    dw 0x8000

    dw 0                  ; Segmento del buffer
    ; Este último elemento es el sector que queremos leer.
