...
.copy_payload:
    ...
    ; - ERROR: la posición original en 0x20000 incumple una de las reglas para
    ;   ubicarla adecuadamente. Vamos a probar con una nueva posición.
    ...
    ; ERROR x 2: tres bytes en un registro de dos es difícil :(
    ; mov edi, 0x0009e000
    ; - lo corregiremos en cmdline_ok.asm
    mov di, 0x9e000
.copy_cmd:
    lodsb          ; Lee de DS:ESI y copia a AL
    stosb          ; Escribe en ES:SI
    test al, al
    jnz .copy_cmd  ; sigue copiando hasta que sea 0.

    ; Puntero cmdline en setup_header + 0x228
    ; ERROR:
    ; mov dword [0x00090000 + 0x228], 0x00020000
    mov dword [0x00090000 + 0x228], 0x0009e000
