...
unreal_mode:
    ...
    ; NG: son 8192 bytes / 16 sectores.
    mov cx, 16            ; total de sectores a leer.
    ...
    ;   Hemos cargado en 0x8000, a eso le sumamos 8180 (8192 - 12).
    mov esi, 0x8000
    ; NG: antes 4084, ahora 8180.
    add esi, 8180
