...
_start:
    ...
    ; PD[0] -> 0-2MB
    ; El flag 0x83 significa:
    ; - Bit 0 (Present) = 1
    ; - Bit 1 (Write) = 1
    ; - Bit 7 (Page Size) = 1 (página de 2MB)
    ; mov dword [edi + 0x2000], 0x83

    ; Agregamos Write-Through para la VGA
    ; - La memoria VGA debe ser accesible sin caché (write-through o uncached).
...
start_long_mode:
    ...
    ; 0000000000300050 T kernel_entry
